            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="SalesRepPro.php">Product Sales Reports</a>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Sales Report Products</h1>
    <div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to download the sales report for this product?
            </div>
...
function downloadPDF() {
    ...
    html2canvas(element).then(canvas => {
        ...
        pdf.save("Product Sales Report.pdf");
    }).catch(err => {
